...
class ReplayBuffer(BaseBuffer):
    def __init__(self, size: int, o_size, a_size, b_size, *args, **kwargs):
        ...
        # self.observations = collections.deque(maxlen=size)
        # self.actions = collections.deque(maxlen=size)
        # self.next_observations = collections.deque(maxlen=size)
        # self.rewards = collections.deque(maxlen=size)
        # self.dones = collections.deque(maxlen=size)
    ...
    def add_experience(self, experience: Experience):
        ...
        if end > self.size:
            ...
            self.actions[start: end] = experience.actions[:split]
